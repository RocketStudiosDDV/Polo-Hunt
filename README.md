...
Polar Hunt
## Género
Es un juego multijugador party en 3D 
## Audiencia
...
El juego en la versión de salida dispone de dos modos principales. Durante los dos próximos años esta lista irá aumentado incorporando nuevos modos y vertientes de los anteriores. 
...
•	Osos: Los osos pueden correr, pero la duración de su carrera está limitada por una barra de aguante con un tiempo de refresco una vez se consuma por completo. De esta manera se balancea la ventaja de velocidad que este tiene frente a los adversarios.
...
-	Motos de nieve
-	Muñecos de nieve
-	Telesillas derrumbados
-	Cañones de nieve
-	Túneles 


Por otra parte, hay unas rampas que al atravesarlas otorgan un impulso de velocidad una vez se aterriza. Los peces repartidos por el escenario también ofrecen una aceleración extra una vez se comen.
...
- El tiempo restante
- La habilidad del animal en concreto
- El número de pingüinos restantes
Interfaz de modo carrera:
-	Se indica la posición en la carrera con respecto a los otros jugadores. 
...
•	Al solar un cepo
•	Al pisar un cepo
•	Al usar la visión Berserker
•	Al volver a disponer de la habilidad
•	Al terminar de fracturar un hielo quebrado
•	Al cazar a un pingüino
•	Al caer en el agua
•	Al llegar a la meta
•	Al acabar el tiempo 

# Experiencia de usuario
Este juego tiene un gran desafío por esta parte. Conseguir la diversión del jugador es la clave para el éxito del producto y para ello tenemos 5 reglas principales:
•	El movimiento de los personajes debe ser atractivo a la hora de su manejo, pero con la premisa de que la torpeza de los movimientos, se encuentren en un balance entre las físicas de los personajes y la influencia del escenario.

•	Los modos de juego deben de tener una complejidad muy ligera. El usuario debe poder comprender el juego y sus reglas en apenas 30 segundos de explicación. Para este tipo de explicaciones vamos a usar como influencias los tutoriales que salen los Mario´s Party ya que, al contener tantos minijuegos, se han centrado en poder explicar el funcionamiento de cada uno en un tiempo mínimo.
...
Cada mes se sacará un modo de juego adicional de los que hay en la siguiente lista:
- Modo Zombie
- Modo Sumo
- Modo Talento
- Modo Fiesta
...
Cada semana saldrá una skin nueva y cada dos meses saldrá un paquete temático de 5 skins adicionales que se podrán comprar al conjunto con un precio reducido.
